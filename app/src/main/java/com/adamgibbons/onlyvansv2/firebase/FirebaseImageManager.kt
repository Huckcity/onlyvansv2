...
object FirebaseImageManager {
    ...
    fun checkStorageForExistingProfilePic(userid: String) {
        val imageRef = storage.child("photos").child("${userid}/${userid}.jpg")
    ...
    fun uploadVanImageToFirebase(van: VanModel, bitmap: Bitmap) {
    ...
    fun uploadUserImageToFirebase(userid: String, bitmap: Bitmap, updating : Boolean) {
    ...
    fun updateVanImage(van: VanModel, imageUri: String) {
        Picasso.get().load(imageUri)
            .into(object : Target {
                override fun onBitmapLoaded(bitmap: Bitmap?,
                    ...
                    uploadVanImageToFirebase(van, bitmap!!)
                }
        ...
        Picasso.get().load(imageUri)
            ...
            .into(object : Target {
                override fun onBitmapLoaded(bitmap: Bitmap?,
                    ...
                    Timber.i("DX onBitmapLoaded $bitmap")
                    uploadUserImageToFirebase(userid, bitmap!!,updating)
        ...
        Picasso.get().load(resource)
            ...
            .into(object : Target {
                override fun onBitmapLoaded(bitmap: Bitmap?,
                    ...
                    Timber.i("DX onBitmapLoaded $bitmap")
                    uploadUserImageToFirebase(userid, bitmap!!,false)
                    imageView.setImageBitmap(bitmap)
                }
